...
const CTAFinal = () => {
  return (
    <section className="py-12 px-6 sm:px-10 md:px-20 lg:px-32 xl:px-48 text-white bg-gradient-to-b from-transparent to-black relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-0">
        <motion.h2
        ...
        >
          Tomemos un café ☕ y contanos tu idea.  
          Queremos conocerte y ayudarte a llevar tu proyecto al siguiente nivel.
        </motion.p>
